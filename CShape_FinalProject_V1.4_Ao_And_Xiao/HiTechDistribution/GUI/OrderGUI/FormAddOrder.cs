...
namespace HiTechDistribution.GUI.OrderGUI
{
    ...
    public partial class FormAddOrder : Form
    {
        ...
        //create orderId automatically
        private void createId()
        {
            labelOrderId.Text = "OD" + DateTime.Now.ToString("yyMMddHHmmss");
        ...
        private void listViewNewOrder_SelectedIndexChanged(object sender, EventArgs e)
        {
